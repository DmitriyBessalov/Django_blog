   ...
   return (
        <form>
            <div className="text-center mb-4">
                    <h1 className="h3 mb-3 font-weight-normal">Повторное подтверждение Email</h1>
            </div>
            ...
            <button className="btn btn-lg btn-primary btn-block" type="submit">Отправить</button>
        </form>
  )
}